...
import com.cee.admin.commons.AppConstants;
import com.cee.admin.controller.jsf.AppMB;
import com.cee.admin.entity.UfEntity;
...
@PlcConfigAggregation(
		entity = com.cee.admin.entity.UfEntity.class,

		details = {
			@com.powerlogic.jcompany.config.aggregation.PlcConfigDetail(
				clazz = com.cee.admin.entity.CidadeEntity.class,
